...
#figure(
  scale(x: 85%, y: 85%, reflow: true, diagram(
    node-stroke: 0.5pt,
    ...
    node((1, 0), [Basisgraph], name: <bg>),
    node((2, 0), [Voronoi-Partition], name: <vor>),
    node((3, 0), [Gate Nodes], name: <gates>),
    node((4, 0), [Abstrakter Graph], name: <ag>),
    ...
    node((0, 1), [Start, Ziel], name: <input>),
    node((1, 1), [Anbindung], name: <attach>),
    node((2, 1), [Abstrakte Suche], name: <asearch>),
    node((3, 1), [Refinement], name: <refine>),
    node((4, 1), [Konkreter Pfad], name: <path>),
    ...
    // Datenuebergabe von Build- zu Query-Phase (gestrichelt, Label auf der Linie)
    edge(<ag>, <asearch>, "-|>",
