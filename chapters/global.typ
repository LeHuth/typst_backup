...
#let filename(it) = text(font:"DejaVu Sans Mono", size: 10pt,it)
//
// E.g. format shell commands and command line tools: git, Python, curl
// PT Mono not available on Linux distribution, we try DejaVu Sans Mono
#let command(it) = [
  #set text(font:"DejaVu Sans Mono",size: 10pt, style: "oblique")
  #h(0.1em, weak: false)
  '#it'
  #h(0.3em, weak: true)
]
